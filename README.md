...
3. Navigate to maincourse_java_jfse_mc05_AKS_ingress_autoscaling_springboot_exercise folder

    `cd maincourse_java_jfse_mc05_AKS_ingress_autoscaling_springboot_exercise`
